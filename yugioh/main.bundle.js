...
var ShowCardComponent = (function () {
    ...
    ShowCardComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__["Observable"].timer(3000).subscribe(function () {
            _this.trapActivateState = "hidden";
        });
        __WEBPACK_IMPORTED_MODULE_1_rxjs_Rx__["Observable"].timer(3500).subscribe(function () {
...
module.exports = "<h3>\n  You have picked card number <span>{{card}}</span>. Are you sure?\n</h3>\n<div class=\"row center-xs middle-xs\">\n  <div class=\"col-xs\">\n    <button routerLink=\"/choose-card\">No, go back</button>\n  </div>\n  <div class=\"col-xs\">\n   <img src=\"/assets/hand-over-card.png\">\n  </div>\n  <div class=\"col-xs\">\n    <button routerLink=\"/show-card\">Yeah, I choose that</button>\n  </div>\n</div>  \n"
